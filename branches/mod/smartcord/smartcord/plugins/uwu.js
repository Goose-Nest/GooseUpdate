...
module.exports = new Plugin({
  name: "UwU (fake)" /* Human-readable plugin name. */,
  author:
    "smartfridge#5834" /* [Optional] Put your name here to give yourself credit for making it :) */,
  description:
    "This is a fake plugin so people don't get broken plugin. Feel free to remove uwu.js from your plugins folder." /* Description of what this plugin does. */,
